...
{
	towerBase = Sprite::createWithSpriteFrameName(StringUtils::format("archer_tower_000%d.png",level));

	shooter_1 = Sprite::createWithSpriteFrameName(StringUtils::format("tower_archer_lvl%d_shooter_0001.png",level));
	shooter_2 = Sprite::createWithSpriteFrameName(StringUtils::format("tower_archer_lvl%d_shooter_0001.png",level));
