...
{
	setName(StringUtils::format("level%d_Artillery_",level));
	towerBase = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer1_0001.png",level));
	leftShooter = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer2_0001.png",level));
	rightShooter = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer3_0001.png",level));
	barrel = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer4_0001.png",level)); 
	smoke = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer5_0001.png",level)); 
	c4 = Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer6_0001.png",level));  
	...
	addChild(smoke);
	addChild(c4);
	addChild(Sprite::createWithSpriteFrameName(StringUtils::format("tower_artillery_lvl%d_layer7_0001.png",level)));
