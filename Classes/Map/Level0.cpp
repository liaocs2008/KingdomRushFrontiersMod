...
void Level0::addTerrains()
{
	...
	terrain1->setPosition(Point(600,780));//�����
	terrain1->setTag(1);
	addChild(terrain1,3);
	...
	terrain8->setPosition(Point(600,270));//�������
	terrain8->setTag(8);
	addChild(terrain8,8);
